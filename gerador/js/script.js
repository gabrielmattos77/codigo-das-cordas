...
function gerarNotaGrafada(notaTonica, intervalo, grau) {
    ...
    if (indiceLetraTonica === -1) {
        return notasCromaticas[
            (valoresNotas[notaTonica] + intervalo) % 12
        ];
    }

    const indiceLetra =
        (indiceLetraTonica + grau) % 7;
...
function gerarCampoHarmonico(notasEscala, tipoEscala) {

    // O campo harmônico diatônico precisa de 7 notas
    if (!Array.isArray(notasEscala) || notasEscala.length !== 7) {
        return null;
    }
    ...
    // ==================================================
    // GERAR TRÍADES E TÉTRADES
    // ==================================================

    const triadesResultado =
        grausCampo.map(function (grau, indice) {
...
if (!botao || !seletorNota || !seletorEscala || !resultado) {
...
if (botao) {
    ...
    botao.addEventListener("click", function () {
        ...
        const nomesDosIntervalos =
            escalaSelecionada.intervalos.map(
                function (intervalo) {
                    ...
                    return obterNomeIntervalo(intervalo);
        ...
        let campoHarmonico =
            gerarCampoHarmonico(escala, tipoEscala);
                ...
                <table>
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th>Intervalo desde a tônica</th>
                    ...
                    <tbody>
                        ...
                        ${escala.map(function (nota, indice) {
